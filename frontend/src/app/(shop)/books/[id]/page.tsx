          ...
          <div className="flex flex-col gap-10 lg:col-span-7">
            <header className="flex flex-col gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <span className="text-xs font-bold uppercase tracking-[0.08em] text-[#58615b]">
                  Genre
                </span>
                {genreList.length > 0 ? (
                  genreList.map((genre) => (
                    <span
                      key={genre}
                      className="rounded-full bg-[#e8f0e9] px-3 py-1 text-xs font-semibold text-[#2b352f]"
                    >
                      {genre}
                    </span>
                  ))
                ) : (
                  <span className="rounded-full bg-[#e8f0e9] px-3 py-1 text-xs font-semibold text-[#2b352f]">
                    Updating
                  </span>
                )}
              </div>
