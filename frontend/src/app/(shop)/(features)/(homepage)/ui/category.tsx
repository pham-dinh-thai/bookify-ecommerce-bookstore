...
export default function Category({ genres }: CategoryProps) {
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-[#58615b] max-w-xs">
                Open this collection to browse every available book in the{' '}
                {featuredGenre.name} genre.
              </p>
            </div>
              ...
              >
                <div className="flex h-full min-h-[168px] justify-between gap-6">
                  <div>
                    ...
                    >
                      View all books currently assigned to {genre.name}.
                    </p>
                  </div>
                  <Icon
                    size={36}
