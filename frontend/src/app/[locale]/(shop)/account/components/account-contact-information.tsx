...
export default function AccountContactInformation() {
  const t = useTranslations('account.contactInfo');
              ...
              >
                ...
                <div className="mt-7 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                  ...
                  >
                    ...
                    {savingPhone ? tc('saving') : t('updatePhone')}
                  </button>
                </div>
              </form>
              ...
              <div className="rounded-lg bg-[#eff5ef] p-5 shadow-sm sm:p-8">
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <span className="w-fit rounded-full bg-white px-3 py-1 text-xs font-bold text-[#58615b]">
                    {contact?.addresses.length ?? 0} {t('saved')}
                  </span>
                </div>
                ...
                <form className="mt-8" onSubmit={handleAddressSubmit}>
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    <label className="block space-y-2">
                      ...
                      >
                        <option value="">{tc('selectProvince')}</option>
                    ...
                    <label className="block space-y-2">
                      ...
                      >
                        <option value="">
                          {loadingWards ? tc('loadingWards') : tc('selectWard')}
                        </option>
                        {wards.map((ward) => (
