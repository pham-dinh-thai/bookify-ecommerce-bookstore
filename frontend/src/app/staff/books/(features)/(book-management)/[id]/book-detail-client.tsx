  ...
  return (
    <div className="p-12 max-w-7xl mx-auto">
      <div className="flex flex-col gap-6 mb-12">
        <div className="flex items-center gap-2 text-xs uppercase tracking-[0.18em] font-bold text-[#58615b]">
          <Link
            href="/staff/books"
            className="hover:text-[#335b48] transition-colors"
          >
            Lưu trữ
          </Link>
          ...
          <span className="text-[#335b48]">Chi tiết bản ghi</span>
        </div>
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <button
            type="button"
            onClick={() =>
              addToast('Save action is not implemented yet', 'info')
            }
            className="inline-flex items-center gap-3 rounded-xl bg-[#3f6754] px-8 py-4 text-sm font-bold text-[#e6ffef] shadow-lg shadow-[#3f6754]/10 transition-transform hover:bg-[#335b48] active:scale-[0.98]"
          >
            <span
